...
public class FrameSequenceDrawable extends Drawable implements Animatable, Runnable {
                ...
                synchronized (FrameSequenceDrawable.this.mLock) {
                    ...
                    synchronized (FrameSequenceDrawable.this.mLock) {
                        ...
                        if (FrameSequenceDrawable.this.mDestroyed) {
                            ...
                            FrameSequenceDrawable.this.mNextSwap = z ? Util.VLI_MAX : j + FrameSequenceDrawable.this.mLastSwap;
    ...
    public Bitmap getFrontBitmap() {
        Bitmap createBitmap;
        synchronized (this.mLock) {
            createBitmap = (this.mFrontBitmap == null || this.mFrontBitmap.isRecycled()) ? null : Bitmap.createBitmap(this.mFrontBitmap);
        }
        return createBitmap;
    }
}
