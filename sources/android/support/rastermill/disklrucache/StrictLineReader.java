package android.support.rastermill.disklrucache;
...
class StrictLineReader implements Closeable {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: android.support.rastermill.disklrucache.StrictLineReader.1
