...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        if (z) {
            AudioManager audioManager = (AudioManager) this.mContext.getApplicationContext().getSystemService(ListWidget.EXTRA_TYPE_AUDIO);
    ...
    */
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & ThemeManager.UI_MODE_THEME_MASK) != (configuration2.screenLayout & ThemeManager.UI_MODE_THEME_MASK)) {
                configuration3.screenLayout |= configuration2.screenLayout & ThemeManager.UI_MODE_THEME_MASK;
            }
