...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider(DMEnd.REASON_NETWORK) : null;
    ...
    private void updateState(@NonNull Location location) {
        ...
        if (j3 == -1 || j4 == -1) {
            ...
            j = (currentTimeMillis > j4 ? 0 + j5 : currentTimeMillis > j3 ? 0 + j4 : 0 + j3) + OkGo.DEFAULT_MILLISECONDS;
        }
