...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mVoiceWebSearchIntent.addFlags(ClientDefaults.MAX_MSG_SIZE);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(ClientDefaults.MAX_MSG_SIZE);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < 960 || i2 < 720 || configuration.orientation != 2) {
                return i < 600 ? (i < 640 || i2 < 480) ? SpeechConstant.SoundLocation.MAX_ANGLE : ThemeManager.UI_MODE_THEME_MASK : ThemeManager.UI_MODE_THEME_MASK;
            }
            return 256;
        }
