...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i9 = i;
                int i25 = (int) (findPreviousPosition.x * i9);
                i11 = i17;
                i10 = i2;
                i12 = findPreviousPosition.frame;
                i4 = (int) (findPreviousPosition.y * i10);
                i5 = i25;
            } else {
                i9 = i;
                i10 = i2;
            ...
            if (findNextPosition != null) {
                i8 = (int) (findNextPosition.x * i9);
                i13 = findNextPosition.frame;
                i18 = (int) (findNextPosition.y * i10);
            } else {
                i8 = i11;
                i13 = 100;
            }
    ...
    public boolean setValue(String str, CLElement cLElement) throws CLParsingException {
        ...
        switch (str.hashCode()) {
            ...
            case 115029:
                ...
                break;
            case 3317767:
                if (str.equals(AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT)) {
                    c = 14;
                    break;
                }
                c = 65535;
            ...
            case 92909918:
                ...
                break;
            case 108511772:
                if (str.equals(AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT)) {
                    c = 15;
                    break;
                }
                c = 65535;
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        sb.append("{\n");
        add(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT, this.left);
        add(sb, "top", this.top);
        add(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT, this.right);
