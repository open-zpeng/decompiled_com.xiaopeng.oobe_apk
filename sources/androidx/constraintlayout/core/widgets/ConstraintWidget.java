...
public class ConstraintWidget {
    ...
    public StringBuilder serialize(StringBuilder sb) {
        sb.append("{\n");
        serializeAnchor(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT, this.mLeft);
        serializeAnchor(sb, "top", this.mTop);
        serializeAnchor(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT, this.mRight);
    ...
    /* JADX WARN: Removed duplicated region for block: B:322:0x05fd  */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:271:0x0485, code lost:
        if ((r3 instanceof androidx.constraintlayout.core.widgets.Barrier) != false) goto L247;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:244:0x0402 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:365:0x058b A[ADDED_TO_REGION] */
    ...
    */
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour = new int[DimensionBehaviour.values().length];

        static {
            try {
                $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour[DimensionBehaviour.FIXED.ordinal()] = 1;
            ...
            $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type = new int[ConstraintAnchor.Type.values().length];
            try {
                $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[ConstraintAnchor.Type.LEFT.ordinal()] = 1;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        getSceneString(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT, this.mLeft);
        getSceneString(sb, "top", this.mTop);
        getSceneString(sb, AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT, this.mRight);
