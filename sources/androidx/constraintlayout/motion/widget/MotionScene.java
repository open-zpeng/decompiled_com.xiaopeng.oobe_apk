        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int currentState, Transition transition) {
                ...
                if (view != null) {
                    ...
                    boolean z = true;
                    boolean z2 = ((this.mMode & 1) != 0 && currentState == i2) | ((this.mMode & 1) != 0 && currentState == i2) | ((this.mMode & 256) != 0 && currentState == i2) | ((this.mMode & 16) != 0 && currentState == i3);
                    if ((this.mMode & 4096) == 0 || currentState != i3) {
                        z = false;
                    }
                    if (z2 || z) {
                        view.setOnClickListener(this);
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (peekValue.type == 1) {
                        ...
                        this.mDefaultInterpolatorString = a.getString(index);
                    ...
                    this.mDuration = a.getInt(index, this.mDuration);
                    if (this.mDuration < 8) {
                        this.mDuration = 8;
                    }
                ...
                try {
                    ...
                    switch (attributeValue.hashCode()) {
                        case -768416914:
                            ...
                            break;
                        case 3317767:
                            if (attributeValue.equals(AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT)) {
                                z2 = true;
                                break;
                            }
                            z2 = true;
                        ...
                        case 3387192:
                            ...
                            break;
                        case 108511772:
                            if (attributeValue.equals(AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT)) {
                                z2 = true;
                                break;
                            }
                            z2 = true;
