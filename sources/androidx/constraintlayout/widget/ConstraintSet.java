                    ...
                    try {
                        ...
                        if (type == Integer.TYPE) {
                            ...
                            if (num.intValue() != -1) {
                                ...
                                stringBuilder.append(lookUpConstraintName);
                                stringBuilder.append("\"\n");
                            }
                ...
                switch (mapToConstant.get(index)) {
                    ...
                    case 10:
                        ...
                        if (peekValue.type == 1) {
                            ...
                            if (this.mQuantizeInterpolatorString.indexOf(MqttTopic.TOPIC_LEVEL_SEPARATOR) > 0) {
                                this.mQuantizeInterpolatorID = obtainStyledAttributes.getResourceId(index, -1);
                                this.mQuantizeInterpolatorType = -2;
                                break;
                            } else {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 86:
                    ...
                    if (peekValue.type == 1) {
                        ...
                        if (c.motion.mQuantizeInterpolatorString.indexOf(MqttTopic.TOPIC_LEVEL_SEPARATOR) > 0) {
                            c.motion.mQuantizeInterpolatorID = a.getResourceId(index, -1);
                            delta.add(89, c.motion.mQuantizeInterpolatorID);
                            c.motion.mQuantizeInterpolatorType = -2;
                            delta.add(88, c.motion.mQuantizeInterpolatorType);
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{AccountConfig.FaceIDRegisterAction.ORIENTATION_LEFT, AccountConfig.FaceIDRegisterAction.ORIENTATION_RIGHT, "top", "bottom", AccountConfig.FaceIDRegisterAction.STATUS_START, DMWait.STATUS_END}, -1);
