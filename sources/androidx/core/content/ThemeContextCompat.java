...
public class ThemeContextCompat {
    private static final String TAG = "ContextCompat";
    private static final Object sLock = new Object();
    private static TypedValue sTempValue;

    protected ThemeContextCompat() {
    }
    ...
    private static synchronized File createFilesDir(File file) {
        synchronized (ThemeContextCompat.class) {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(AudioManager.class, ListWidget.EXTRA_TYPE_AUDIO);
            ...
            SERVICES.put(SearchManager.class, SpeechWidget.TYPE_SEARCH);
