    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            if (i6 == i5 || (i6 != i && centeredArray.get(i6 + 1) > centeredArray.get(i6 - 1))) {
                ...
                int i7 = centeredArray.get(i6 - 1);
                i3 = i7;
                i2 = i7 + 1;
            }
            int i8 = (range.newListStart + (i2 - range.oldListStart)) - i6;
            int i9 = (i == 0 || i2 != i3) ? i8 : i8 - 1;
            while (i2 < range.oldListEnd && i8 < range.newListEnd) {
                if (!callback.areItemsTheSame(i2, i8)) {
                    break;
                }
                i2++;
                i8++;
            ...
            if (z && (i4 = oldSize - i6) >= i5 + 1 && i4 <= i - 1) {
                if (centeredArray2.get(i4) <= i2) {
    ...
    private static Snake backward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            if (i6 == i5 || (i6 != i && centeredArray2.get(i6 + 1) < centeredArray2.get(i6 - 1))) {
                ...
                int i7 = centeredArray2.get(i6 - 1);
                i3 = i7;
                i2 = i7 - 1;
            }
            int i8 = range.newListEnd - ((range.oldListEnd - i2) - i6);
            int i9 = (i == 0 || i2 != i3) ? i8 : i8 + 1;
            while (i2 > range.oldListStart && i8 > range.newListStart) {
                if (!callback.areItemsTheSame(i2 - 1, i8 - 1)) {
                    break;
                }
                i2--;
                i8--;
            ...
            if (z && (i4 = oldSize - i6) >= i5 && i4 <= i) {
                if (centeredArray.get(i4) >= i2) {
                    Snake snake = new Snake();
                    snake.startX = i2;
                    snake.startY = i8;
                    snake.endX = i3;
