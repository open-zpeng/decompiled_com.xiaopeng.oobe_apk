        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i10, BasicMeasure.EXACTLY);
                } else {
                    ...
                    if (childAt2.getVisibility() != i4) {
                        ...
                        if (z2 && childAt2 != this.mSlideableView) {
                            ...
                            if (z2) {
                                ...
                                i5 = i11;
                                int makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i13, BasicMeasure.EXACTLY);
