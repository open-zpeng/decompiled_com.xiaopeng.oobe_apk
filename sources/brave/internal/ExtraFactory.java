...
public abstract class ExtraFactory<E> {
    ...
    public final TraceContext decorate(TraceContext traceContext) {
            ...
            if (type.isInstance(obj3)) {
                if (obj2 == null) {
                    ...
                    if (tryToClaim(obj3, traceId, spanId)) {
                        ...
                        ensureMutable = Lists.ensureMutable(list);
        ...
        if (obj2 == null) {
            ...
            list = Lists.ensureMutable(list);
            list.add(createExtraAndClaim);
        }
        return list == traceContext.extra() ? traceContext : contextWithExtra(traceContext, Collections.unmodifiableList(list));
    }
