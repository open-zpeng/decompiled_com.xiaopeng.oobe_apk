    ...
    private static <T> Keyframe<T> parseMultiDimensionalKeyframe(LottieComposition lottieComposition, JsonReader jsonReader, float f, ValueParser<T> valueParser) throws IOException {
        ...
        if (z) {
            ...
            if (pointF5 != null && pointF6 != null) {
                ...
                Interpolator interpolatorFor2 = interpolatorFor(pointF7, pointF9);
                interpolatorFor = interpolatorFor(pointF8, pointF10);
                interpolator2 = interpolatorFor2;
                t = t3;
                interpolator = null;
                if (interpolator2 == null && interpolatorFor != null) {
                    pointF = pointF19;
                    keyframe = new Keyframe<>(lottieComposition, t2, t, interpolator2, interpolatorFor, f13, null);
                } else {
                    pointF = pointF19;
