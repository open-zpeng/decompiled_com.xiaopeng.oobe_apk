        ...
        */
        public static void commit(java.lang.String r10, java.lang.String r11, com.alibaba.mtl.appmonitor.model.DimensionValueSet r12, com.alibaba.mtl.appmonitor.model.MeasureValueSet r13, java.util.Map<java.lang.String, java.lang.String> r14) {
            /*
                ...
                goto L77
            Le:
                com.alibaba.mtl.log.b.a.u()     // Catch: java.lang.Throwable -> L7f
                boolean r1 = com.alibaba.mtl.appmonitor.AppMonitorDelegate.i     // Catch: java.lang.Throwable -> L7f
                r2 = 3
                ...
                r8 = 4
                if (r1 == 0) goto L65
                boolean r1 = com.alibaba.mtl.log.a.a.f()     // Catch: java.lang.Throwable -> L7f
                if (r1 == 0) goto L65
                com.alibaba.mtl.appmonitor.a.f r1 = com.alibaba.mtl.appmonitor.a.f.STAT     // Catch: java.lang.Throwable -> L7f
                boolean r1 = r1.isOpen()     // Catch: java.lang.Throwable -> L7f
                if (r1 == 0) goto L65
                boolean r1 = com.alibaba.mtl.appmonitor.AppMonitorDelegate.IS_DEBUG     // Catch: java.lang.Throwable -> L7f
                if (r1 != 0) goto L3e
                com.alibaba.mtl.appmonitor.a.f r1 = com.alibaba.mtl.appmonitor.a.f.STAT     // Catch: java.lang.Throwable -> L7f
                if (r12 == 0) goto L37
                java.util.Map r9 = r12.getMap()     // Catch: java.lang.Throwable -> L7f
                goto L38
            L37:
                r9 = 0
            L38:
                boolean r1 = com.alibaba.mtl.appmonitor.d.j.a(r1, r10, r11, r9)     // Catch: java.lang.Throwable -> L7f
                if (r1 == 0) goto L65
            L3e:
                ...
                com.alibaba.mtl.log.d.i.a(r1, r8)     // Catch: java.lang.Throwable -> L7f
                com.alibaba.mtl.log.b.a.v()     // Catch: java.lang.Throwable -> L7f
                com.alibaba.mtl.appmonitor.a.e r1 = com.alibaba.mtl.appmonitor.a.e.a()     // Catch: java.lang.Throwable -> L7f
                com.alibaba.mtl.appmonitor.a.f r2 = com.alibaba.mtl.appmonitor.a.f.STAT     // Catch: java.lang.Throwable -> L7f
            ...
            L77:
                ...
                com.alibaba.mtl.log.d.i.a(r0, r1)     // Catch: java.lang.Throwable -> L7f
                return
            L7f:
                r0 = move-exception
