...
public class b implements com.alibaba.mtl.log.c.a {
    a a;
    String ae = "SELECT * FROM %s ORDER BY %s ASC LIMIT %s";
    String af = "SELECT count(*) FROM %s";
    String ag = "DELETE FROM log where _id in ( select _id from log  ORDER BY _id ASC LIMIT %d )";
    ...
    /* renamed from: a */
    public synchronized boolean mo24a(List<com.alibaba.mtl.log.model.a> list) {
        a aVar;
        if (list != null) {
            if (list.size() != 0) {
                        ...
                        while (true) {
                            try {
                                ...
                                if (aVar2 != null) {
                                    ...
                                    contentValues.put("eventId", aVar2.X);
                                    contentValues.put(Progress.PRIORITY, aVar2.Y);
                                    contentValues.put("content", aVar2.j());
                                    contentValues.put("time", aVar2.aa);
                                    contentValues.put("_index", aVar2.ab);
                                    long insert = sQLiteDatabase.insert("log", "", contentValues);
                                    if (insert == -1) {
                                        break;
                                    }
                                    i.a("UTSqliteLogStore", "[insert] ", aVar2.ab, " isSuccess:", true, "ret", Long.valueOf(insert));
                                }
                                i++;
                            } catch (Throwable th) {
                                th = th;
        ...
        try {
            ...
            if (writableDatabase != null) {
                ...
                while (rawQuery != null && rawQuery.moveToNext()) {
                    ...
                    aVar.X = rawQuery.getString(rawQuery.getColumnIndex("eventId"));
                    aVar.Y = rawQuery.getString(rawQuery.getColumnIndex(Progress.PRIORITY));
                    aVar.l(rawQuery.getString(rawQuery.getColumnIndex("content")));
                    aVar.aa = rawQuery.getString(rawQuery.getColumnIndex("time"));
                    try {
                        aVar.ab = rawQuery.getString(rawQuery.getColumnIndex("_index"));
                    } catch (Throwable unused2) {
                    }
                    arrayList.add(aVar);
                }
    ...
    public synchronized int g() {
        ...
        i = 0;
        if (writableDatabase != null) {
            Cursor rawQuery = writableDatabase.rawQuery(String.format(this.af, "log"), null);
            if (rawQuery != null) {
    ...
    public void e(int i) {
        ...
        try {
            writableDatabase.execSQL(String.format(this.ag, Integer.valueOf(i)));
        } catch (Throwable unused) {
        }
        this.a.a(writableDatabase);
    }
