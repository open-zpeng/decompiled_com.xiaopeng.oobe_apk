...
public class h {
    ...
    public static Map<String, String> m26a(Map<String, String> map) {
        ...
        try {
            String n = b.n();
            if (!TextUtils.isEmpty(n) && !map.containsKey(LogField.USERNICK.toString())) {
                map.put(LogField.USERNICK.toString(), n);
            }
            String k = b.k();
            ...
            String l = b.l();
            if (!TextUtils.isEmpty(l) && !map.containsKey(LogField.LL_USERID.toString())) {
                map.put(LogField.LL_USERID.toString(), l);
            }
