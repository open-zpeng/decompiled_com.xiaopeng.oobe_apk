...
public final class Beacon {
    ...
    public static final class Builder {
        ...
        public Builder loopInterval(long j) {
            if (j < OkGo.DEFAULT_MILLISECONDS) {
                this.mLoopInterval = OkGo.DEFAULT_MILLISECONDS;
            } else {
    ...
    private Beacon(Builder builder) {
        ...
        this.f72a = new HandlerThread("Beacon Daemon");
        this.f72a.start();
        a();
    }
    ...
    public void d(Context context) {
        this.f73a.m32a(context, this.mAppKey, this.mAppSecret, this.mExtras);
        List<Config> a = this.f73a.a();
        for (OnUpdateListener onUpdateListener : this.f74a) {
