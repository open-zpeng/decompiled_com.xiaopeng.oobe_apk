...
public final class b {
    ...
    private C0010b a(Context context, String str, String str2, Map<String, String> map) {
        return new C0010b.a().a(str).b(str2).c(c.a(context)).d("Android").e(String.valueOf(Build.VERSION.SDK_INT)).f(UTDevice.getUtdid(context)).g("1.0.7").a(map).a();
    }
    ...
    private void b(String str) {
        ...
        try {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                this.c.add(new Beacon.Config(jSONObject.optString(CacheEntity.KEY), jSONObject.optString("value")));
            }
    ...
    public void m32a(Context context, String str, String str2, Map<String, String> map) {
        ...
        String a3 = this.f76a.a(str3, a(a2).getBytes());
