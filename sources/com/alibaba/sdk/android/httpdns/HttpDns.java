...
public class HttpDns implements HttpDnsService {
    ...
    private String[] getIpsByHost(String str) {
        if (!b.a()) {
            ...
            e m42a = hostManager.m42a(str);
            if (m42a != null && m42a.m51b() && this.isExpiredIPEnabled) {
                if (!hostManager.m47a(str)) {
                    i.d("refresh host async: " + str);
                    c.a().submit(new m(str, o.QUERY_HOST));
                }
                return m42a.m50a();
            } else if (m42a != null && !m42a.m51b()) {
                return m42a.m50a();
            } else {
    ...
    private static void reportHttpDnsSuccess(String str, int i) {
        ...
        if (a != null) {
            a.a(str, i, com.alibaba.sdk.android.httpdns.d.b.b(), com.alibaba.sdk.android.httpdns.b.b.m33a() ? 1 : 0);
        }
    }
    ...
    private static void reportUserGetIP(String str, int i) {
        com.alibaba.sdk.android.httpdns.d.a a = com.alibaba.sdk.android.httpdns.d.a.a();
        if (a != null) {
            a.b(str, i, com.alibaba.sdk.android.httpdns.d.b.b(), com.alibaba.sdk.android.httpdns.b.b.m33a() ? 1 : 0);
        }
    }
    ...
    */
    public java.lang.String[] getIpsByHostAsync(java.lang.String r7) {
        ...
        L31:
            ...
            com.alibaba.sdk.android.httpdns.e r0 = r0.m42a(r7)
            if (r0 == 0) goto L40
            boolean r3 = r0.m51b()
            if (r3 == 0) goto L79
            goto L41
    ...
    public void setPreResolveHosts(ArrayList<String> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (k.b(str) && !hostManager.m47a(str)) {
                c.a().submit(new m(str, o.QUERY_HOST));
            }
        }
    }
