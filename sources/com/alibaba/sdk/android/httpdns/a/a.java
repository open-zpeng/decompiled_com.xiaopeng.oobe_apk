...
public class a {
    ...
    private com.alibaba.sdk.android.httpdns.d.a f80a = null;

    /* renamed from: a  reason: collision with other field name */
    private Beacon f79a = null;
    private boolean h = true;

    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnUpdateListener f78a = new Beacon.OnUpdateListener() { // from class: com.alibaba.sdk.android.httpdns.a.a.1
    ...
    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnServiceErrListener f77a = new Beacon.OnServiceErrListener() { // from class: com.alibaba.sdk.android.httpdns.a.a.2
    ...
    public void a(Context context, String str) {
        ...
        if (this.mContext != null) {
            ...
            this.f79a = new Beacon.Builder().appKey("24657847").appSecret("f30fc0937f2b1e9e50a1b7134f1ddb10").loopInterval(7200000L).extras(hashMap).build();
            this.f79a.addUpdateListener(this.f78a);
            this.f79a.addServiceErrListener(this.f77a);
            this.f79a.start(this.mContext.getApplicationContext());
        }
    }
