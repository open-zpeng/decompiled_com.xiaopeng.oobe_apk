...
public class a {
    ...
    public void a(Context context, String str) {
        ...
        if (this.mContext != null) {
            ...
            this.f77a = new Beacon.Builder().appKey("24657847").appSecret("f30fc0937f2b1e9e50a1b7134f1ddb10").loopInterval(7200000L).extras(hashMap).build();
            this.f77a.addUpdateListener(this.f76a);
