...
public class a {
    ...
    private AlicloudTrackerManager f89a;
    ...
    private a(Context context) {
        ...
        this.f89a = AlicloudTrackerManager.getInstance((Application) context.getApplicationContext());
        AlicloudTrackerManager alicloudTrackerManager = this.f89a;
    ...
    public void i() {
        ...
        if (alicloudTracker != null) {
            alicloudTracker.sendCustomHit(UTWrapper.BZ_ACTIVE, null);
        } else {
    ...
    public void k(String str) {
        ...
        if (!this.i) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put(MqttServiceConstants.TRACE_EXCEPTION, str);
