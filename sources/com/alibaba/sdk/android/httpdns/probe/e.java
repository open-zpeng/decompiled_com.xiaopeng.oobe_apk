...
public class e implements IPProbeService {
    ...
    private AtomicLong f106a = new AtomicLong(0);

    /* renamed from: b  reason: collision with other field name */
    private ConcurrentHashMap<String, Long> f107b = new ConcurrentHashMap<>();
    private b a = null;
    private f b = new f() { // from class: com.alibaba.sdk.android.httpdns.probe.e.1
        ...
        public void a(long j, c cVar) {
            if (cVar != null) {
                if (!e.this.f107b.containsKey(cVar.getHostName()) || ((Long) e.this.f107b.get(cVar.getHostName())).longValue() != j) {
                    ...
                    e.this.f107b.remove(cVar.getHostName());
                }
            }
        }
    };
    ...
    public IPProbeService.a getProbeStatus(String str) {
        return this.f107b.containsKey(str) ? IPProbeService.a.PROBING : IPProbeService.a.NO_PROBING;
    }
    ...
    public void launchIPProbeTask(String str, int i, String[] strArr) {
        if (!com.alibaba.sdk.android.httpdns.a.a.a().f()) {
            ...
            long addAndGet = this.f106a.addAndGet(1L);
            this.f107b.put(str, Long.valueOf(addAndGet));
