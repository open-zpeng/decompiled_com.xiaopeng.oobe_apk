...
public class a implements b {
    ...
    final class RunnableC0017a implements Runnable {
        ...
        public boolean m65a(CrashReportDataForSave crashReportDataForSave) {
        ...
        private String a(CrashReportDataForSave crashReportDataForSave) {
            String mo55a;
            try {
                if (crashReportDataForSave.nativeCrashPath == null || (mo55a = a.this.f132a.mo55a(crashReportDataForSave.nativeCrashPath)) == null) {
                    return "";
                }
        ...
        public void e() {
            try {
                ...
                } else if ((this.D == 1 || this.D == 2) && m65a(this.f137a)) {
                    a(this.f137a, 0);
                }
            } catch (Exception e) {
