...
public class LogThreadPoolManager {
    ...
    private final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(1, 1, UILooperObserver.ANR_TRIGGER_TIME, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(500), new ThreadFactory() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.2
        @Override // java.util.concurrent.ThreadFactory
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "oss-android-log-thread");
        }
    }, this.mHandler);
    private final Runnable mAccessBufferThread = new Runnable() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.3
