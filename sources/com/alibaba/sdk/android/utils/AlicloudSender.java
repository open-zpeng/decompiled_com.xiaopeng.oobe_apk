...
public class AlicloudSender {
    ...
    private static final String f160a = null;

    /* renamed from: a  reason: collision with other field name */
    private static AtomicBoolean f161a = new AtomicBoolean(false);
    private static Map<String, SdkInfo> b;

    /* renamed from: b  reason: collision with other field name */
    private static ExecutorService f162b;
    ...
    private static void a(Application application, SdkInfo sdkInfo) {
        if (f161a.compareAndSet(false, true)) {
            b = new ConcurrentHashMap();
            c = m75a(application.getApplicationContext());
            a = new SendService();
            a.openHttp = true;
            ...
            f162b = new ThreadPoolExecutor(0, 1, 30L, TimeUnit.SECONDS, new SynchronousQueue());
    ...
    public static void a(final Context context, final SdkInfo sdkInfo) {
        f162b.execute(new Runnable() { // from class: com.alibaba.sdk.android.utils.AlicloudSender.2
    ...
    public static synchronized void b(Context context, SdkInfo sdkInfo) {
        synchronized (AlicloudSender.class) {
            ...
            hashMap.put("kVersion", O000000o.O00000oo);
    ...
    private static Map<String, a> m75a(Context context) {
        HashMap hashMap = new HashMap();
