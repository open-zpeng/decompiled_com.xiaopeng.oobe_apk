...
public class AlicloudTracker {
    ...
    private Map<String, String> f164d = new HashMap();
    ...
    public void setGlobalProperty(String str, String str2) {
        if (!TextUtils.isEmpty(str) && str2 != null) {
            if (this.f164d.containsKey(str)) {
                this.f164d.remove(str);
            }
            this.f164d.put(str, str2);
            return;
        }
    ...
    public void removeGlobalProperty(String str) {
        if (!TextUtils.isEmpty(str) && this.f164d.containsKey(str)) {
            this.f164d.remove(str);
        } else {
