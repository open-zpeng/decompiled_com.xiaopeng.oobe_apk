...
public class AlicloudTrackerManager {
    ...
    private c f165a = new c();

    /* renamed from: a  reason: collision with other field name */
    private com.alibaba.sdk.android.utils.crashdefend.b f166a;
    ...
    private AlicloudTrackerManager(Application application) {
        ...
        this.f165a.a(application, hashMap);
        this.e = new HashMap();
        this.f166a = com.alibaba.sdk.android.utils.crashdefend.b.a(application, this.f165a);
    }
    ...
    public AlicloudTracker getTracker(String str, String str2) {
        ...
        AlicloudTracker alicloudTracker = new AlicloudTracker(this.f165a, str, str2);
    ...
    public boolean registerCrashDefend(String str, String str2, int i, int i2, SDKMessageCallback sDKMessageCallback) {
        if (this.f166a != null) {
            ...
            cVar.b = i;
            cVar.c = i2;
            return this.f166a.m80a(cVar, sDKMessageCallback);
        }
        return false;
    }

    public void unregisterCrashDefend(String str, String str2) {
        this.f166a.d(str, str2);
    }
}
