...
public class c {
    ...
    public void d() {
        ...
        if (z) {
            synchronized (this) {
                if (this.f126b != null && !this.f126b.isShutdown()) {
                    this.f126b.shutdown();
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x0086 A[Catch: all -> 0x00aa, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x000a, B:8:0x0012, B:9:0x0018, B:11:0x001e, B:13:0x0026, B:15:0x0030, B:17:0x003a, B:18:0x0055, B:20:0x0059, B:21:0x0076, B:23:0x0078, B:26:0x0086, B:27:0x00a8), top: B:32:0x0003 }] */
    /*
    ...
    */
    private com.alibaba.sdk.android.utils.crashdefend.d a(com.alibaba.sdk.android.utils.crashdefend.d r9, com.alibaba.sdk.android.utils.crashdefend.SDKMessageCallback r10) {
        /*
            ...
            monitor-enter(r0)
            java.util.List<com.alibaba.sdk.android.utils.crashdefend.d> r1 = r8.f125b     // Catch: java.lang.Throwable -> Laa
            r2 = 0
            r3 = 1
            r4 = 0
            if (r1 == 0) goto L83
        ...
        L18:
            ...
            if (r5 == 0) goto L18
            java.lang.String r6 = r5.f129a     // Catch: java.lang.Throwable -> Laa
            java.lang.String r7 = r9.f129a     // Catch: java.lang.Throwable -> Laa
            boolean r6 = r6.equals(r7)     // Catch: java.lang.Throwable -> Laa
            if (r6 == 0) goto L18
            java.lang.String r1 = r5.f131b     // Catch: java.lang.Throwable -> Laa
            java.lang.String r6 = r9.f131b     // Catch: java.lang.Throwable -> Laa
            boolean r1 = r1.equals(r6)     // Catch: java.lang.Throwable -> Laa
            if (r1 != 0) goto L55
            java.lang.String r1 = r9.f131b     // Catch: java.lang.Throwable -> Laa
            r5.f131b = r1     // Catch: java.lang.Throwable -> Laa
            int r1 = r9.a     // Catch: java.lang.Throwable -> Laa
            r5.a = r1     // Catch: java.lang.Throwable -> Laa
            int r1 = r9.b     // Catch: java.lang.Throwable -> Laa
            r5.b = r1     // Catch: java.lang.Throwable -> Laa
            r5.c = r2     // Catch: java.lang.Throwable -> Laa
            r8.e()     // Catch: java.lang.Throwable -> Laa
            com.alibaba.sdk.android.utils.crashdefend.a r1 = r8.f123b     // Catch: java.lang.Throwable -> Laa
        ...
        L55:
            ...
            java.lang.String r9 = r9.f129a     // Catch: java.lang.Throwable -> Laa
            ...
            return r4
        L78:
            r5.e = r3     // Catch: java.lang.Throwable -> Laa
            r5.f128a = r10     // Catch: java.lang.Throwable -> Laa
            com.alibaba.sdk.android.utils.crashdefend.b r1 = r8.f122a     // Catch: java.lang.Throwable -> Laa
            long r6 = r1.a     // Catch: java.lang.Throwable -> Laa
            r5.f130b = r6     // Catch: java.lang.Throwable -> Laa
            goto L84
        L83:
            r5 = r4
        L84:
            ...
            com.alibaba.sdk.android.utils.crashdefend.b r9 = r8.f122a     // Catch: java.lang.Throwable -> Laa
            long r9 = r9.a     // Catch: java.lang.Throwable -> Laa
            r5.f130b = r9     // Catch: java.lang.Throwable -> Laa
            java.util.List<com.alibaba.sdk.android.utils.crashdefend.d> r9 = r8.f125b     // Catch: java.lang.Throwable -> Laa
            r9.add(r5)     // Catch: java.lang.Throwable -> Laa
            com.alibaba.sdk.android.utils.crashdefend.a r9 = r8.f123b     // Catch: java.lang.Throwable -> Laa
