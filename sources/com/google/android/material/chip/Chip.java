...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ThemeManager.AttributeSet.BACKGROUND) != null) {
            Log.w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ThemeManager.AttributeSet.DRAWABLE_LEFT) != null) {
            throw new UnsupportedOperationException("Please set left drawable using R.attr#chipIcon.");
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ThemeManager.AttributeSet.DRAWABLE_START) != null) {
            throw new UnsupportedOperationException("Please set start drawable using R.attr#chipIcon.");
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ThemeManager.AttributeSet.DRAWABLE_END) != null) {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ThemeManager.AttributeSet.DRAWABLE_RIGHT) != null) {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
