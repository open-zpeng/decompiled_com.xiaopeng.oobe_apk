...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            TypeAdapterFactory createAdapterFactory3 = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(str);
            if (z) {
                ...
                createAdapterFactory = createAdapterFactory3;
            } else {
                createAdapterFactory = createAdapterFactory3;
            ...
            createAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i, i2);
            if (z) {
                typeAdapterFactory = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i, i2);
                createAdapterFactory2 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i, i2);
            }
            createAdapterFactory2 = null;
        }
