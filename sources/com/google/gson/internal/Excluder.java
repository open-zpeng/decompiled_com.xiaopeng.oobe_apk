...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m83clone = m83clone();
        m83clone.modifiers = 0;
        for (int i : iArr) {
            m83clone.modifiers = i | m83clone.modifiers;
        }
        return m83clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder m83clone = m83clone();
        m83clone.serializeInnerClasses = false;
        return m83clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder m83clone = m83clone();
        m83clone.requireExpose = true;
        return m83clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder m83clone = m83clone();
        if (z) {
            m83clone.serializationStrategies = new ArrayList(this.serializationStrategies);
            m83clone.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            m83clone.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            m83clone.deserializationStrategies.add(exclusionStrategy);
        }
        return m83clone;
    }
