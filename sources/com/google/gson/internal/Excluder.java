...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m63clone = m63clone();
        m63clone.modifiers = 0;
        for (int i : iArr) {
            m63clone.modifiers = i | m63clone.modifiers;
        }
        return m63clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder m63clone = m63clone();
        m63clone.serializeInnerClasses = false;
        return m63clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder m63clone = m63clone();
        m63clone.requireExpose = true;
        return m63clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder m63clone = m63clone();
        if (z) {
            m63clone.serializationStrategies = new ArrayList(this.serializationStrategies);
            m63clone.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            m63clone.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            m63clone.deserializationStrategies.add(exclusionStrategy);
        }
        return m63clone;
    }
