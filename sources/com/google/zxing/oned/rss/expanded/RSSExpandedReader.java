...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, 143, 7, 21, 63}, new int[]{189, SpeechConstant.SoundLocation.PASSENGER_END_ANGLE, 13, 39, 117, 140, 209, 205}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, 169, 85, 44, 132}, new int[]{185, 133, 188, 142, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, 138, 203, 187, 139, 206, 196, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, TarConstants.PREFIXLEN}, new int[]{43, 129, 176, 106, 107, 110, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, 178, 112, 125, 164}, new int[]{70, NaviPreferenceBean.PATH_PREF_UNPAVED, 208, 202, 184, 130, 179, 115}, new int[]{134, 191, 151, 31, 93, 68, 204, 190}, new int[]{TarConstants.CHKSUM_OFFSET, 22, 66, 198, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, ThemeManager.UI_MODE_THEME_MASK, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, 175}, new int[]{103, 98, 83, 38, 114, TarConstants.PREFIXLEN_XSTAR, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, SpeechConstant.SoundLocation.MAX_ANGLE, 58, 174, 100, 89}};
    ...
    */
    ...
    private boolean checkChecksum() {
        ...
        return ((i + (-4)) * NaviPreferenceBean.PATH_PREF_AVOID_UNPAVED) + (checksumPortion % NaviPreferenceBean.PATH_PREF_AVOID_UNPAVED) == leftChar.getValue();
    }
