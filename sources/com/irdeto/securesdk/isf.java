...
public class isf {
    ...
    public static String isfEncrypt(String str) throws ISFException {
        ...
        if (isfProvisioned()) {
            try {
                ...
                O000000o o000000o = O000000o.ISF_CS_DECRYPT_FAILED;
                throw new ISFException(o000000o, e.getMessage() + "(" + e.getErrorCode() + ")");
            }
        }
        throw new ISFException(O000000o.ISF_MGR_NOT_PROVISIONED);
    }
    ...
    public static String isfGenerateOpaqueData() throws ISFException {
        if (isfProvisioned()) {
            ...
            O000000o o000000o = O000000o.ISF_MGR_GENERATE_OPAQUE_DATA_FAILED;
            throw new ISFException(o000000o, feedback.message + "(" + feedback.errorCode + ")");
        }
        throw new ISFException(O000000o.ISF_MGR_NOT_PROVISIONED);
    }
    ...
    public static byte[] isfGetMCUSecurityAsset() throws ISFException {
        ...
        O000000o o000000o = O000000o.ISF_MGR_UNKNOWN;
        throw new ISFException(o000000o, feedback.message + "(" + String.format("%x", Integer.valueOf(feedback.errorCode)) + ")");
    }
    ...
    public static byte[] isfStoreGet(String str, FileIndex fileIndex) throws ISFException {
        ...
        O000000o o000000o = O000000o.ISF_SS_READ_FAILED;
        throw new ISFException(o000000o, feedback.message + "(" + String.format("%x", Integer.valueOf(feedback.errorCode)) + ")");
    }
