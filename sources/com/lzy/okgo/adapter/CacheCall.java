...
public class CacheCall<T> implements Call<T> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$lzy$okgo$cache$CacheMode = new int[CacheMode.values().length];

        static {
            try {
                $SwitchMap$com$lzy$okgo$cache$CacheMode[CacheMode.DEFAULT.ordinal()] = 1;
