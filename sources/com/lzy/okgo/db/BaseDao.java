...
public abstract class BaseDao<T> {
    ...
    public boolean insert(T t) {
        ...
        try {
            ...
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " insertT");
        }
    }
    ...
    public boolean insert(List<T> list) {
        ...
        try {
            ...
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " insertList");
        }
    }
    ...
    public boolean delete(String str, String[] strArr) {
        ...
        try {
            try {
                ...
                this.lock.unlock();
                String str3 = TAG;
                OkLogger.v(str3, (System.currentTimeMillis() - currentTimeMillis) + " delete");
                return false;
            }
        } finally {
            this.database.endTransaction();
            this.lock.unlock();
            str2 = TAG;
            OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " delete");
        }
    }
    ...
    public boolean deleteList(List<Pair<String, String[]>> list) {
        ...
        try {
            try {
                ...
                this.lock.unlock();
                String str2 = TAG;
                OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " deleteList");
                return false;
            }
        } finally {
            this.database.endTransaction();
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " deleteList");
        }
    }
    ...
    public boolean replace(T t) {
        ...
        try {
            ...
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " replaceT");
        }
    }
    ...
    public boolean replace(ContentValues contentValues) {
        ...
        try {
            try {
                ...
                this.lock.unlock();
                String str2 = TAG;
                OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " replaceContentValues");
                return false;
            }
        } finally {
            this.database.endTransaction();
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " replaceContentValues");
        }
    }
    ...
    public boolean replace(List<T> list) {
        ...
        try {
            ...
            this.lock.unlock();
            str = TAG;
            OkLogger.v(str, (System.currentTimeMillis() - currentTimeMillis) + " replaceList");
        }
    }
    ...
    public boolean update(T t, String str, String[] strArr) {
        ...
        try {
            ...
            this.lock.unlock();
            str2 = TAG;
            OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " updateT");
        }
    }
    ...
    public boolean update(ContentValues contentValues, String str, String[] strArr) {
        ...
        try {
            try {
                ...
                this.lock.unlock();
                String str3 = TAG;
                OkLogger.v(str3, (System.currentTimeMillis() - currentTimeMillis) + " updateContentValues");
                return false;
            }
        } finally {
            this.database.endTransaction();
            this.lock.unlock();
            str2 = TAG;
            OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " updateContentValues");
        }
    }
    ...
    public T queryOne(String str, String[] strArr) {
        ...
        String str2 = TAG;
        OkLogger.v(str2, (System.currentTimeMillis() - currentTimeMillis) + " queryOne");
        if (query.size() > 0) {
            return query.get(0);
        }
        return null;
