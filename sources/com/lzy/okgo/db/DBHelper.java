...
class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(Context context) {
        ...
        this.cacheTableEntity.addColumn(new ColumnEntity(CacheEntity.KEY, "VARCHAR", true, true)).addColumn(new ColumnEntity(CacheEntity.LOCAL_EXPIRE, "INTEGER")).addColumn(new ColumnEntity(CacheEntity.HEAD, "BLOB")).addColumn(new ColumnEntity(CacheEntity.DATA, "BLOB"));
