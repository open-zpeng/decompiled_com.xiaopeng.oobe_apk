...
public class b {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        C0023b c0023b = new C0023b(i3, new byte[(i2 * 3) / 4]);
        if (!c0023b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0023b.a == c0023b.b.length) {
            return c0023b.b;
        }
        byte[] bArr2 = new byte[c0023b.a];
        System.arraycopy(c0023b.b, 0, bArr2, 0, c0023b.a);
        return bArr2;
    }
    ...
    public static class c extends a {
        ...
        /* JADX WARN: Removed duplicated region for block: B:104:0x0097 A[EDGE_INSN: B:104:0x0097->B:27:0x0097 ?: BREAK  , SYNTHETIC] */
