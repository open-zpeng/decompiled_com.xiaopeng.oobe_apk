...
public class b {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        if (!c0016b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0016b.a == c0016b.b.length) {
            return c0016b.b;
        }
        byte[] bArr2 = new byte[c0016b.a];
        System.arraycopy(c0016b.b, 0, bArr2, 0, c0016b.a);
        return bArr2;
    }
