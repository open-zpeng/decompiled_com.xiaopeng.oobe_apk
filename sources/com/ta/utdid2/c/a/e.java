...
class e {
    ...
    public static final HashMap m97a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m98a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                if (name.equals(TypedValues.Custom.S_FLOAT)) {
                    ...
                    xmlPullParser.next();
                    int[] m98a = m98a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m98a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m97a = m97a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m97a;
