...
class e {
    ...
    public static final HashMap m77a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m78a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                if (name.equals(TypedValues.Custom.S_FLOAT)) {
                    ...
                    xmlPullParser.next();
                    int[] m78a = m78a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m78a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m77a = m77a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m77a;
