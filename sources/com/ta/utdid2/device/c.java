...
public class c {
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m71a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            if (!i.m71a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m71a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (!i.m71a(this.b.getString("SI"))) {
                this.b.remove("SI");
                z = true;
            }
            if (z) {
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (i.m71a(string) || this.f154a.a(string) == null) {
                return null;
            }
            return string;
        }
