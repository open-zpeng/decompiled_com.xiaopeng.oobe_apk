...
public class UTPageHitHelper {
    ...
    private String m99a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m102a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m101a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m99a = m99a(obj);
        if (this.A.containsKey(m99a)) {
            return this.A.get(m99a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m99a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m99a);
    ...
    private synchronized void m100b(Object obj) {
        String m99a = m99a(obj);
        if (this.A.containsKey(m99a)) {
            this.A.remove(m99a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m99a = m99a(obj);
            if (m99a != null && m99a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
