...
public class UTPageHitHelper {
    ...
    private String m79a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m82a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m81a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        ...
        if (this.A.containsKey(m79a)) {
            return this.A.get(m79a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m79a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m79a);
    ...
    private synchronized void m80b(Object obj) {
        String m79a = m79a(obj);
        if (this.A.containsKey(m79a)) {
            this.A.remove(m79a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m79a = m79a(obj);
            if (m79a != null && m79a.equals(this.ah)) {
                return;
            }
            if (this.ah != null) {
