...
public class CounterImpl implements ICounter, Handler.Callback {
    ...
    public CounterImpl(Context context, String str, long j) {
        ...
        this.mTime = new AtomicLong(this.mPreferences.getLong(generatePrefKey(KEY_TIME), System.currentTimeMillis()));
    ...
    public synchronized int count(String str, int i) {
        ...
        if (this.mDebug) {
            LogUtils.v(TAG, "count " + this.mName + " " + str + ":" + i3 + ", cache is:" + this.mCountMap);
        }
        boolean z = true;
