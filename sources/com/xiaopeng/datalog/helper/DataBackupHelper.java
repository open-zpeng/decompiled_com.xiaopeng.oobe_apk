...
public class DataBackupHelper {
    ...
    public void deleteExpiredFile(final String str, Context context) {
        ...
        for (String str2 : list) {
            if (isExpiredFile(str2)) {
                arrayList.add(str2);
                boolean delete = new File(DATA_FILE_DIR + str + MqttTopic.TOPIC_LEVEL_SEPARATOR + context.getPackageName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + str2).delete();
    ...
    private boolean isExpiredFile(String str) {
        ...
        if (DateUtils.dateToStamp(formatDate10.substring(0, 8) + "_000000") - DateUtils.dateToStamp(str2) > EXPIRE_TIME_THRESHOLD) {
    ...
    private File createNewFile(String str, Context context) {
        String formatDate10 = DateUtils.formatDate10(System.currentTimeMillis());
        return new File(DATA_FILE_DIR + str + MqttTopic.TOPIC_LEVEL_SEPARATOR + context.getPackageName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + str + "_" + formatDate10 + ".log");
    }
