...
public class ApiRouter {
    ...
    private static RemoteOperator publishModule(@NonNull UriStruct uriStruct, @NonNull IBinder iBinder, @NonNull String str) {
    ...
    public static <T> T route(@NonNull Uri uri, byte[] bArr) throws RemoteException {
        return (T) route(uri, true, bArr);
    }

    private static <T> T route(@NonNull Uri uri, boolean z, byte[] bArr) throws RemoteException {
