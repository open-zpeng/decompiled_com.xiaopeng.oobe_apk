...
public class TrafficStatsEntry {
    ...
    static {
        sEntry.clear();
        sEntry.put(IpcConfig.App.CAR_OTA, new Entry(100000, TAG_APP_OTA));
        sEntry.put(BuildConfig.APPLICATION_ID, new Entry(100001, TAG_APP_OOBE));
        ...
        sEntry.put(Constants.TTS_ENGINE_AISPEECH, new Entry(100017, TAG_APP_CAR_SPEECH_SERVICE));
    ...
    public static List<HashMap<String, Object>> getTrafficInfo() {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                JSONArray jSONArray = new JSONObject(sb.toString()).getJSONArray(CacheEntity.DATA);
                if (jSONArray != null) {
