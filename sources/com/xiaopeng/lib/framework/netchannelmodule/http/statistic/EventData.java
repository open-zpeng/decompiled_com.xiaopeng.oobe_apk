...
public class EventData {
    ...
    public void connectFailed(InetSocketAddress inetSocketAddress, Proxy proxy, @Nullable Protocol protocol, IOException iOException) {
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            if (this.mRespBodySize > 0) {
                jSONObject.put("bs", this.mRespBodySize);
            }
            if (this.mRespCode > 0) {
                jSONObject.put("cd", this.mRespCode);
            }
            if (this.mCallException != null) {
                jSONObject.put("ce", this.mCallException);
                jSONObject.put("ta", NetUtils.getTrafficStatus());
            }
            if (this.mMethod != null) {
                jSONObject.put("md", this.mMethod);
            }
