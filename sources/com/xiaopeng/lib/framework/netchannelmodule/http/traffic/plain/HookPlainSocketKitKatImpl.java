...
public class HookPlainSocketKitKatImpl extends SocketImpl implements SocketOptions {
    ...
    protected InputStream getInputStream() throws IOException {
        ...
        if (socketImpl != null && (method = this.mHookGetInputStream) != null) {
            try {
                this.mInputStream = new CountingInputStream(this.mCollector, (InputStream) method.invoke(socketImpl, new Object[0]));
    ...
    protected OutputStream getOutputStream() throws IOException {
        ...
        if (socketImpl != null && (method = this.mHookGetOutputStream) != null) {
            try {
                this.mOutputStream = new CountingOutputStream(this.mCollector, (OutputStream) method.invoke(socketImpl, new Object[0]));
