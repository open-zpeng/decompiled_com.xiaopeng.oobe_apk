...
public class HookTLSKitkatSocket {
    ...
    private static class KitKatTLSInputStream extends CountingInputStream {
        ...
        public KitKatTLSInputStream(@NonNull ICollector iCollector, @NonNull SSLSocket sSLSocket) throws IOException {
    ...
    private static class KitKatTLSOutputStream extends CountingOutputStream {
        ...
        public KitKatTLSOutputStream(@NonNull ICollector iCollector, @NonNull SSLSocket sSLSocket) throws IOException {
            super(iCollector, null);
            this.socket = sSLSocket;
        }
