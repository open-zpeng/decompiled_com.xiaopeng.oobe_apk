...
public class HttpsUtils {
    ...
    @Deprecated
    public static void setSSLSocketFactoryWrapper(@NonNull ISSLSocketFactoryWrapper iSSLSocketFactoryWrapper) {
    }
    ...
    public static void setSSLSocketWrapper(@NonNull SSLHelper.ISSLSocketWrapper iSSLSocketWrapper) {
