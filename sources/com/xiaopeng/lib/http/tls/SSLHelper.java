...
public class SSLHelper {
    ...
    public static class TLS2SocketFactory extends SSLSocketFactory {
        ...
        public Socket createSocket(Socket socket, String str, int i, boolean z) throws IOException {
            ...
            return patch(createSocket, str + ":" + i);
        }
        ...
        public Socket createSocket(InetAddress inetAddress, int i) throws IOException {
            ...
            sb.append(":");
            sb.append(i);
            return patch(this.delegate.createSocket(inetAddress, i), sb.toString());
        }
        ...
        public Socket createSocket(InetAddress inetAddress, int i, InetAddress inetAddress2, int i2) throws IOException {
            ...
            sb.append(":");
            sb.append(i);
            return patch(this.delegate.createSocket(inetAddress, i, inetAddress2, i2), sb.toString());
        }
    ...
    public static void setSSLSocketWrapper(@NonNull ISSLSocketWrapper iSSLSocketWrapper) {
