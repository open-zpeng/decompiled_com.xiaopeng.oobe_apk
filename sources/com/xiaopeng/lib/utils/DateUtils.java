...
public class DateUtils {
    ...
    public static synchronized String getWeeklyFormatString(Calendar calendar) {
        String str;
        synchronized (DateUtils.class) {
            Calendar mondayOfWeek = getMondayOfWeek(calendar);
            Calendar sundayOfWeek = getSundayOfWeek(calendar);
            str = sDailySimpleFormat.format(Long.valueOf(mondayOfWeek.getTimeInMillis())) + " - " + sDailySimpleFormat.format(Long.valueOf(sundayOfWeek.getTimeInMillis()));
        }
        return str;
    }
