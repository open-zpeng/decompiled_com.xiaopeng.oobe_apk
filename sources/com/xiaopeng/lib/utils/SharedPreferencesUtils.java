...
public class SharedPreferencesUtils {
    ...
    private SharedPreferencesUtils(@NonNull Context context, String str, int i) {
    ...
    public static SharedPreferencesUtils getInstance(@NonNull Context context, String str) {
        init(context, str);
        return instance;
    }
