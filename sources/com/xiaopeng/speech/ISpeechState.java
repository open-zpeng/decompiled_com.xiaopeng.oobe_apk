    ...
    public static abstract class Stub extends Binder implements ISpeechState {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 21:
                    parcel.enforceInterface(DESCRIPTOR);
                    String canPerformASRToText = canPerformASRToText(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeString(canPerformASRToText);
                    return true;
                default:
        ...
        private static class Proxy implements ISpeechState {
            ...
            @Override // com.xiaopeng.speech.ISpeechState
            public String canPerformASRToText(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
