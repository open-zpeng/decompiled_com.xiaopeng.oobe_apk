...
public interface IRecognizeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRecognizeListener {
        ...
        public static IRecognizeListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IRecognizeListener)) {
                return (IRecognizeListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onResult(parcel.readString(), parcel.readInt() != 0);
                ...
                parcel.enforceInterface(DESCRIPTOR);
                onState(parcel.readInt(), parcel.readInt());
                parcel2.writeNoException();
                return true;
            } else if (i != 4) {
                if (i == 1598968902) {
                ...
                parcel.enforceInterface(DESCRIPTOR);
                onExtra(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readString(), parcel.createByteArray());
                parcel2.writeNoException();
                return true;
            }
        }
