...
public class SpeechConstant {
    ...
    public static final String KEY_ENABLE_BACK_LEFT = "key.enable.back.left";
    public static final String KEY_ENABLE_BACK_RIGHT = "key.enable.back.right";
    ...
    public static final String KEY_SPEECH_SCENE_STATE = "key.speech.scene.state";
    ...
    /* loaded from: classes.dex */
    public static class SPEECH_SCENE_STATE {
