            ...
            if (textArray != null) {
                ...
                for (int i2 = 0; i2 < textArray.length; i2++) {
                    if (!TextUtils.isEmpty(textArray[i2])) {
                        ...
                        if (split.length == 2) {
                            if (!OOBEEvent.STRING_TRUE.equals(split[1])) {
                                if (OOBEEvent.STRING_FALSE.equals(split[1])) {
    ...
    default void setTextWatcherChanged(final TextView textView) {
        ...
        textView.addTextChangedListener(new TextWatcher() { // from class: com.xiaopeng.xui.vui.VuiView.1
            ...
            public void afterTextChanged(Editable editable) {
                ...
                VuiView vuiView = VuiView.this;
                vuiView.logD("afterTextChanged：   " + editable.toString() + "  ===  " + ((Object) textView.getText()));
