...
public class XMenuBar extends XLinearLayout implements View.OnClickListener, IVuiElementListener {
    ...
    public void addTabItem(@NonNull String str, @DrawableRes int i) {
        addTabItem(str, i, -1);
    }

    public void addTabItem(@NonNull CharSequence charSequence, @DrawableRes int i, int i2) {
    ...
    public boolean onVuiElementEvent(final View view, VuiEvent vuiEvent) {
        ...
        post(new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XMenuBar$pvlSkWhQOntef4FugJHw5IU3te8
