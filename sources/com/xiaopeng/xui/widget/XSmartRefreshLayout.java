        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8 && !"GONE".equals(childAt.getTag(R.id.srl_tag))) {
                ...
                if (refreshComponent != null && refreshComponent.getView() == childAt) {
                    ...
                    if (i10 != i6) {
                        view.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(Math.max((i10 - marginLayoutParams.bottomMargin) - marginLayoutParams.topMargin, i5), BasicMeasure.EXACTLY));
                    }
            ...
            public void onAnimationEnd(Animator animator) {
                if (animator == null || animator.getDuration() != 0) {
                    ...
                    if (XSmartRefreshLayout.this.mRefreshListener != null) {
                        ...
                        XSmartRefreshLayout.this.finishRefresh(3000);
                    }
        ...
        */
        ...
        public void run() {
            ...
            if (Math.abs(f) > 1.0f) {
                ...
                XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                xSmartRefreshLayout.animationRunnable = null;
                xSmartRefreshLayout.mKernel.moveSpinner(0, true);
    ...
    public class BounceRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (Math.abs(f) >= 1.0f) {
                this.mLastTime = currentAnimationTimeMillis;
                this.mOffset += f;
                XSmartRefreshLayout.this.moveSpinnerInfinitely(this.mOffset);
                XSmartRefreshLayout.this.mHandler.postDelayed(this, this.mFrameDelay);
                return;
            }
            ...
            XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
            xSmartRefreshLayout.animationRunnable = null;
            if (Math.abs(xSmartRefreshLayout.mSpinner) >= Math.abs(this.mSmoothDistance)) {
                XSmartRefreshLayout xSmartRefreshLayout2 = XSmartRefreshLayout.this;
                xSmartRefreshLayout2.animSpinner(this.mSmoothDistance, 0, xSmartRefreshLayout2.mReboundInterpolator, Math.min(Math.max((int) SmartUtil.px2dp(Math.abs(XSmartRefreshLayout.this.mSpinner - this.mSmoothDistance)), 30), 100) * 10);
            }
        }
    }
        ...
        if (this.mSpinner != i) {
            ...
            this.reboundAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.xiaopeng.xui.widget.XSmartRefreshLayout.3
                ...
                public void onAnimationEnd(Animator animator) {
                    if (animator == null || animator.getDuration() != 0) {
                        XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                        xSmartRefreshLayout.reboundAnimator = null;
                        if (xSmartRefreshLayout.mSpinner == 0 && XSmartRefreshLayout.this.mState != RefreshState.None && !XSmartRefreshLayout.this.mState.isOpening && !XSmartRefreshLayout.this.mState.isDragging) {
                            ...
                            XSmartRefreshLayout xSmartRefreshLayout2 = XSmartRefreshLayout.this;
                            xSmartRefreshLayout2.setViceState(xSmartRefreshLayout2.mState);
                        }
                    }
                }
            });
    ...
    protected void moveSpinnerInfinitely(float f) {
        ...
        if (this.mState == RefreshState.TwoLevel && f2 > 0.0f) {
            ...
            if (f2 < i2) {
                ...
                double d = f4 - this.mHeaderHeight;
            ...
            if (f2 > (-i4)) {
                ...
                double d4 = f5 - this.mFooterHeight;
            ...
            public void run() {
                if (this.count == 0) {
                    if (XSmartRefreshLayout.this.mState == RefreshState.None && XSmartRefreshLayout.this.mViceState == RefreshState.Refreshing) {
                        ...
                        XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                        xSmartRefreshLayout.reboundAnimator = null;
                        if (xSmartRefreshLayout.mKernel.animSpinner(0) == null) {
                            XSmartRefreshLayout.this.notifyStateChanged(RefreshState.None);
                        } else {
                ...
                if (onFinish < Integer.MAX_VALUE) {
                    if (XSmartRefreshLayout.this.mIsBeingDragged || XSmartRefreshLayout.this.mNestedInProgress) {
                        ...
                        if (XSmartRefreshLayout.this.mIsBeingDragged) {
                            XSmartRefreshLayout xSmartRefreshLayout2 = XSmartRefreshLayout.this;
                            xSmartRefreshLayout2.mTouchY = xSmartRefreshLayout2.mLastTouchY;
                            XSmartRefreshLayout xSmartRefreshLayout3 = XSmartRefreshLayout.this;
                            xSmartRefreshLayout3.mTouchSpinner = 0;
                            xSmartRefreshLayout3.mIsBeingDragged = false;
                            XSmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, xSmartRefreshLayout3.mLastTouchX, (XSmartRefreshLayout.this.mLastTouchY + XSmartRefreshLayout.this.mSpinner) - (XSmartRefreshLayout.this.mTouchSlop * 2), 0));
                            XSmartRefreshLayout xSmartRefreshLayout4 = XSmartRefreshLayout.this;
                            XSmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, xSmartRefreshLayout4.mLastTouchX, XSmartRefreshLayout.this.mLastTouchY + XSmartRefreshLayout.this.mSpinner, 0));
                        }
                        if (XSmartRefreshLayout.this.mNestedInProgress) {
                            XSmartRefreshLayout xSmartRefreshLayout5 = XSmartRefreshLayout.this;
                            xSmartRefreshLayout5.mTotalUnconsumed = 0;
                            ...
                            xSmartRefreshLayout6.mNestedInProgress = false;
                            xSmartRefreshLayout6.mTouchSpinner = 0;
                        }
                    }
                    if (XSmartRefreshLayout.this.mSpinner > 0) {
                        XSmartRefreshLayout xSmartRefreshLayout7 = XSmartRefreshLayout.this;
                        ValueAnimator animSpinner = xSmartRefreshLayout7.animSpinner(0, onFinish, xSmartRefreshLayout7.mReboundInterpolator, XSmartRefreshLayout.this.mReboundDuration);
                        ...
                        xSmartRefreshLayout8.animSpinner(0, onFinish, xSmartRefreshLayout8.mReboundInterpolator, XSmartRefreshLayout.this.mReboundDuration);
                    } else {
            ...
            if (onFinish < Integer.MAX_VALUE) {
                ...
                if (XSmartRefreshLayout.this.mIsBeingDragged || XSmartRefreshLayout.this.mNestedInProgress) {
                    ...
                    if (XSmartRefreshLayout.this.mIsBeingDragged) {
                        ...
                        xSmartRefreshLayout2.mTouchY = xSmartRefreshLayout2.mLastTouchY;
                        XSmartRefreshLayout xSmartRefreshLayout3 = XSmartRefreshLayout.this;
                        xSmartRefreshLayout3.mTouchSpinner = xSmartRefreshLayout3.mSpinner - max;
                        XSmartRefreshLayout xSmartRefreshLayout4 = XSmartRefreshLayout.this;
                        xSmartRefreshLayout4.mIsBeingDragged = false;
                        int i = xSmartRefreshLayout4.mEnableFooterTranslationContent ? max : 0;
                        XSmartRefreshLayout xSmartRefreshLayout5 = XSmartRefreshLayout.this;
                        float f = i;
                        XSmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, xSmartRefreshLayout5.mLastTouchX, XSmartRefreshLayout.this.mLastTouchY + f + (XSmartRefreshLayout.this.mTouchSlop * 2), 0));
                        XSmartRefreshLayout xSmartRefreshLayout6 = XSmartRefreshLayout.this;
                        XSmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, xSmartRefreshLayout6.mLastTouchX, XSmartRefreshLayout.this.mLastTouchY + f, 0));
                    }
                    if (XSmartRefreshLayout.this.mNestedInProgress) {
                        XSmartRefreshLayout xSmartRefreshLayout7 = XSmartRefreshLayout.this;
                        xSmartRefreshLayout7.mTotalUnconsumed = 0;
                        XSmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 1, xSmartRefreshLayout7.mLastTouchX, XSmartRefreshLayout.this.mLastTouchY, 0));
                        XSmartRefreshLayout xSmartRefreshLayout8 = XSmartRefreshLayout.this;
                        xSmartRefreshLayout8.mNestedInProgress = false;
                        xSmartRefreshLayout8.mTouchSpinner = 0;
                    }
                }
        ...
        */
        ...
        public RefreshKernel requestDefaultTranslationContentFor(@NonNull RefreshComponent refreshComponent, boolean z) {
            if (refreshComponent.equals(XSmartRefreshLayout.this.mRefreshHeader)) {
                if (!XSmartRefreshLayout.this.mManualHeaderTranslationContent) {
                    XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                    xSmartRefreshLayout.mManualHeaderTranslationContent = true;
                    xSmartRefreshLayout.mEnableHeaderTranslationContent = z;
                }
                ...
                XSmartRefreshLayout xSmartRefreshLayout2 = XSmartRefreshLayout.this;
                xSmartRefreshLayout2.mManualFooterTranslationContent = true;
                xSmartRefreshLayout2.mEnableFooterTranslationContent = z;
            }
            return this;
        }
        ...
        public RefreshKernel onAutoRefreshAnimationEnd(Animator animator, boolean z) {
            if (animator == null || animator.getDuration() != 0) {
                XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                xSmartRefreshLayout.reboundAnimator = null;
                if (xSmartRefreshLayout.mRefreshHeader != null) {
        ...
        public RefreshKernel onAutoLoadMoreAnimationEnd(Animator animator, boolean z) {
            if (animator == null || animator.getDuration() != 0) {
                XSmartRefreshLayout xSmartRefreshLayout = XSmartRefreshLayout.this;
                xSmartRefreshLayout.reboundAnimator = null;
                if (xSmartRefreshLayout.mRefreshFooter != null) {
