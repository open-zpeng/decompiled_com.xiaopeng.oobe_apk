...
public class XDialogViewDelegateImpl extends XDialogViewDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public XDialogViewDelegateImpl(XDialogView xDialogView, @NonNull Context context, int i) {
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setCustomView(@NonNull View view, boolean z) {
        this.mContentView.removeAllViews();
        if (z) {
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setCustomView(@LayoutRes int i, boolean z) {
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setPositiveButton(@StringRes int i, XDialogViewInterface.OnClickListener onClickListener) {
        setPositiveButton(i);
        setPositiveButtonListener(onClickListener);
    }

    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setPositiveButton(@Nullable CharSequence charSequence, XDialogViewInterface.OnClickListener onClickListener) {
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setNegativeButton(@StringRes int i, XDialogViewInterface.OnClickListener onClickListener) {
        setNegativeButton(i);
        setNegativeButtonListener(onClickListener);
    }

    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setNegativeButton(@Nullable CharSequence charSequence, XDialogViewInterface.OnClickListener onClickListener) {
    ...
    */
    ...
    public class XDialogContentView extends XLinearLayout {
        ...
        public XDialogContentView(Context context, @Nullable AttributeSet attributeSet) {
