...
public final class Cookie {
    ...
    private static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (encodedPath.startsWith(str)) {
            return str.endsWith(MqttTopic.TOPIC_LEVEL_SEPARATOR) || encodedPath.charAt(str.length()) == '/';
        }
        return false;
    }
    ...
    */
    ...
    private static long parseMaxAge(String str) {
        try {
            ...
            if (str.matches("-?\\d+")) {
                ...
                return org.tukaani.xz.common.Util.VLI_MAX;
            }
            throw e;
        }
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((IInputController.KEYCODE_KNOB_TALKING_BOOK + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
}
