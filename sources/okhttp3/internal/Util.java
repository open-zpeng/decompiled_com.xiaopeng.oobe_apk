...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator() { // from class: okhttp3.internal.-$$Lambda$TEfSBt3hRUlBSSARfPEHsJesTtE
    ...
    public static boolean skipAll(Source source, int i, TimeUnit timeUnit) throws IOException {
        ...
        try {
            ...
            if (deadlineNanoTime == org.tukaani.xz.common.Util.VLI_MAX) {
    ...
    public static ThreadFactory threadFactory(final String str, final boolean z) {
        return new ThreadFactory() { // from class: okhttp3.internal.-$$Lambda$Util$h7t7benxn5wsEKvjxE9svqr_kuY
