...
public final class Transmitter {
    ...
    private final AsyncTimeout timeout = new AsyncTimeout() { // from class: okhttp3.internal.connection.Transmitter.1
    ...
    private IOException maybeReleaseConnection(@Nullable IOException iOException, boolean z) {
        ...
        synchronized (this.connectionPool) {
            ...
            releaseConnectionNoEvents = (this.connection != null && this.exchange == null && (z || this.noMoreExchanges)) ? releaseConnectionNoEvents() : null;
            if (this.connection != null) {
                realConnection = null;
            }
