...
public class AndroidPlatform extends Platform {
    ...
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        public List<Certificate> clean(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), O00000Oo.O000000o, str);
            } catch (IllegalAccessException e) {
    ...
    public SSLContext getSSLContext() {
        if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 22) {
            try {
                return SSLContext.getInstance(XmartV1Constants.TLS_REVISION_1_2);
