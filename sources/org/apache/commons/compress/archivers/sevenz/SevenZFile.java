        ...
        while (true) {
            ...
            if (readUnsignedByte != 0) {
                    ...
                    case 17:
                        ...
                        for (int i4 = 0; i4 < bArr.length; i4 += 2) {
                            if (bArr[i4] == 0 && bArr[i4 + 1] == 0) {
                                sevenZArchiveEntryArr[i3].setName(new String(bArr, i2, i4 - i2, CharsetNames.UTF_16LE));
                                i2 = i4 + 2;
                                i3++;
                            }
                        }
                        if (i2 == bArr.length && i3 == sevenZArchiveEntryArr.length) {
                            break;
                        }
                        break;
                    case 18:
                        ...
                        for (int i5 = 0; i5 < sevenZArchiveEntryArr.length; i5++) {
                            sevenZArchiveEntryArr[i5].setHasCreationDate(readAllOrBits.get(i5));
                            if (sevenZArchiveEntryArr[i5].getHasCreationDate()) {
                                sevenZArchiveEntryArr[i5].setCreationDate(Long.reverseBytes(dataInput.readLong()));
                            }
                        }
                        break;
                    case 19:
                        ...
                        for (int i6 = 0; i6 < sevenZArchiveEntryArr.length; i6++) {
                            sevenZArchiveEntryArr[i6].setHasAccessDate(readAllOrBits2.get(i6));
                            if (sevenZArchiveEntryArr[i6].getHasAccessDate()) {
                                sevenZArchiveEntryArr[i6].setAccessDate(Long.reverseBytes(dataInput.readLong()));
                            }
                        }
                        break;
                    case 20:
                        ...
                        for (int i7 = 0; i7 < sevenZArchiveEntryArr.length; i7++) {
                            sevenZArchiveEntryArr[i7].setHasLastModifiedDate(readAllOrBits3.get(i7));
                            if (sevenZArchiveEntryArr[i7].getHasLastModifiedDate()) {
                                sevenZArchiveEntryArr[i7].setLastModifiedDate(Long.reverseBytes(dataInput.readLong()));
                            }
                        }
                        break;
                    case 21:
                        ...
                        for (int i8 = 0; i8 < sevenZArchiveEntryArr.length; i8++) {
                            sevenZArchiveEntryArr[i8].setHasWindowsAttributes(readAllOrBits4.get(i8));
                            if (sevenZArchiveEntryArr[i8].getHasWindowsAttributes()) {
                                sevenZArchiveEntryArr[i8].setWindowsAttributes(Integer.reverseBytes(dataInput.readInt()));
                            }
                        }
                        break;
                    case 22:
                ...
                for (int i11 = 0; i11 < sevenZArchiveEntryArr.length; i11++) {
                    boolean z = true;
                    sevenZArchiveEntryArr[i11].setHasStream(bitSet == null || !bitSet.get(i11));
                    if (sevenZArchiveEntryArr[i11].hasStream()) {
                        sevenZArchiveEntryArr[i11].setDirectory(false);
                        sevenZArchiveEntryArr[i11].setAntiItem(false);
                        sevenZArchiveEntryArr[i11].setHasCrc(archive.subStreamsInfo.hasCrc.get(i9));
                        sevenZArchiveEntryArr[i11].setCrcValue(archive.subStreamsInfo.crcs[i9]);
                        sevenZArchiveEntryArr[i11].setSize(archive.subStreamsInfo.unpackSizes[i9]);
                        i9++;
                    } else {
                        ...
                        sevenZArchiveEntryArr[i11].setAntiItem(bitSet3 == null ? false : bitSet3.get(i10));
                        sevenZArchiveEntryArr[i11].setHasCrc(false);
                        sevenZArchiveEntryArr[i11].setSize(0L);
                        i10++;
                    }
                }
