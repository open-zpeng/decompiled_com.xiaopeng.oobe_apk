...
public class MqttAsyncClient implements IMqttAsyncClient {
    ...
    public void startReconnectCycle() {
        ...
        this.reconnectTimer.schedule(new ReconnectTask(this, null), (long) reconnectDelay);
    }
    ...
    public void close(boolean z) throws MqttException {
        log.fine(CLASS_NAME, HttpHeaders.HEAD_VALUE_CONNECTION_CLOSE, "113");
        this.comms.close(z);
        log.fine(CLASS_NAME, HttpHeaders.HEAD_VALUE_CONNECTION_CLOSE, "114");
    }
