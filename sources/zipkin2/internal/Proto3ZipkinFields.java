...
public final class Proto3ZipkinFields {
    ...
    static void logAndSkip(Buffer buffer, int i) {
        ...
        if (LOG.isLoggable(Level.FINE)) {
            LOG.fine(String.format("Skipping field: byte=%s, fieldNumber=%s, wireType=%s", Integer.valueOf(buffer.pos), Integer.valueOf(Proto3Fields.Field.fieldNumber(i, buffer.pos)), Integer.valueOf(wireType)));
        }
