...
public final class V2SpanWriter implements Buffer.Writer<Span> {
    ...
    public int sizeInBytes(Span span) {
        ...
        if (!span.annotations().isEmpty()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                Annotation annotation = span.annotations().get(i4);
                i3 += annotationSizeInBytes(annotation.timestamp(), annotation.value(), 0);
            }
            i = i3;
        }
    ...
    public static int endpointSizeInBytes(Endpoint endpoint, boolean z) {
        ...
        int jsonEscapedSizeInBytes = serviceName != null ? JsonEscaper.jsonEscapedSizeInBytes(serviceName) + 17 : 1;
