...
public final class V1SpanConverter {
    ...
    void processAnnotations(V1Span v1Span) {
        ...
        if (v1Annotation4 != null && this.sr != null) {
            ...
            V1Annotation v1Annotation6 = this.cs;
            if (v1Annotation6 != null && (v1Annotation2 = this.cr) != null) {
                maybeTimestampDuration(v1Span, v1Annotation6, v1Annotation2);
            } else {
                V1Annotation v1Annotation7 = this.sr;
                if (v1Annotation7 != null && (v1Annotation = this.ss) != null) {
                    maybeTimestampDuration(v1Span, v1Annotation7, v1Annotation);
                } else {
        ...
        V1Annotation v1Annotation8 = this.ms;
        if (v1Annotation8 != null && this.mr != null) {
            Span.Builder forEndpoint5 = forEndpoint(v1Span, v1Annotation8.endpoint);
            ...
            V1Annotation v1Annotation9 = this.wr;
            if (v1Annotation9 != null) {
                forEndpoint.timestamp(v1Annotation9.timestamp).duration(this.mr.timestamp - this.wr.timestamp);
            } else {
                forEndpoint.timestamp(this.mr.timestamp);
            }
            Span.Builder timestamp = forEndpoint5.timestamp(this.ms.timestamp);
            V1Annotation v1Annotation10 = this.ws;
            timestamp.duration(v1Annotation10 != null ? Long.valueOf(v1Annotation10.timestamp - this.ms.timestamp) : null);
            return;
        }
        V1Annotation v1Annotation11 = this.ms;
        if (v1Annotation11 != null) {
            maybeTimestampDuration(v1Span, v1Annotation11, this.ws);
            return;
        }
        V1Annotation v1Annotation12 = this.mr;
        if (v1Annotation12 != null) {
            V1Annotation v1Annotation13 = this.wr;
            if (v1Annotation13 != null) {
                maybeTimestampDuration(v1Span, v1Annotation13, v1Annotation12);
                return;
            } else {
                maybeTimestampDuration(v1Span, v1Annotation12, null);
                return;
            }
        }
        V1Annotation v1Annotation14 = this.ws;
        if (v1Annotation14 != null) {
            forEndpoint(v1Span, v1Annotation14.endpoint).addAnnotation(this.ws.timestamp, this.ws.value);
        }
        V1Annotation v1Annotation15 = this.wr;
        if (v1Annotation15 != null) {
            forEndpoint(v1Span, v1Annotation15.endpoint).addAnnotation(this.wr.timestamp, this.wr.value);
        }
    }
